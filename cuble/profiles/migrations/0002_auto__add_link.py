...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('profiles_link', (
            ...
            ('title', self.gf('django.db.models.fields.CharField')(null=True, blank=True, max_length=128)),
        ))
    ...
    models = {
        ...
        'profiles.link': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'null': 'True', 'blank': 'True', 'max_length': '128'}),

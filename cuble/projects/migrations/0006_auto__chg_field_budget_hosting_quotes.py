...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Budget.hosting_quotes'
        db.alter_column(u'projects_budget', 'hosting_quotes', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Budget.hosting_quotes'
        raise RuntimeError("Cannot reverse this migration. 'Budget.hosting_quotes' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Budget.hosting_quotes'
        db.alter_column(u'projects_budget', 'hosting_quotes', self.gf('django.db.models.fields.CharField')(max_length=128))
    ...
    models = {
        ...
        u'projects.budget': {
            ...
            'branding_design_about': ('django.db.models.fields.TextField', [], {'default': "u''", 'blank': 'True'}),
            ...
            'hosting_quotes': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'hosting_type': ('django.db.models.fields.IntegerField', [], {'default': '3', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'web_design_stage': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'})
        },
        u'projects.project': {
            'Meta': {'object_name': 'Project'},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['profiles.User']"}),
            'content': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 23, 0, 0)'}),
            ...
            'thumbnail_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'projects'", 'null': 'True', 'to': "orm['filer.File']"}),

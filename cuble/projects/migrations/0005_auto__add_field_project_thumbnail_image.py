...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.thumbnail_image'
        db.add_column(u'projects_project', 'thumbnail_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'projects', null=True, to=orm['filer.File']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.thumbnail_image'
        db.delete_column(u'projects_project', 'thumbnail_image_id')
    ...
    models = {
        ...
        u'projects.budget': {
            ...
            'branding_design_about': ('django.db.models.fields.TextField', [], {}),

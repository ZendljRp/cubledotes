...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Budget.branding_design_about'
        db.alter_column(u'projects_budget', 'branding_design_about', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Budget.branding_design_about'
        db.alter_column(u'projects_budget', 'branding_design_about', self.gf('django.db.models.fields.BooleanField')())
